var combinePoints = require('../lagrange.js').combinePoints;
var crypto = require('crypto');
module.exports = {
    random: random,
    createRandomPolynomial: createRandomPolynomial,
...
function randomPoints(t, points, array) {
    ...
    if (array.length < t) {
        ...
        if (!array.some(function (elem) { return elem[0] === p[0]; })) {
            array.push(p);
        }
